...
import {
  ...
  Settings, LogOut, Menu, X, Moon, Sun, TrendingUp, ChevronLeft, Shield, Clock,
...
const menuItems = [
  ...
  { id: 'vault', label: 'Secure Vault', icon: Shield, number: '04', adminOnly: true },
  { id: 'expenses', label: 'Expenses', icon: CreditCard, number: '05' },
  { id: 'employees', label: 'Employees', icon: Users, number: '06', adminOnly: true },
  { id: 'attendance', label: 'My Attendance', icon: Clock, number: '07', employeeOnly: true },
  { id: 'tax-calculator', label: 'Tax Calculator', icon: Calculator, number: '08' },
  { id: 'analytics', label: 'Analytics', icon: TrendingUp, number: '09', adminOnly: true },
  { id: 'notifications', label: 'Notifications', icon: Bell, number: '10' },
  { id: 'activity', label: 'Activity Log', icon: Activity, number: '11', adminOnly: true },
  { id: 'backup', label: 'Backup/Restore', icon: HardDrive, number: '12', adminOnly: true },
];
